...
## Project Structure
    ...
    ├── testunsavepopup_dev_39381  # Django project configurations
...
1. Clone this repo and `cd testunsavepopup_dev_39381`
...
2. Clone this repo and `cd testunsavepopup_dev_39381`
